...
import keychainRedFlower from '../assets/keychain-red-flower.jpg';
import keychainYellowBloom from '../assets/keychain-yellow-bloom.jpg';
import keychainBlueHeart from '../assets/keychain-blue-heart.jpg';
...
export const getImageByFilename = (imgName) => {
  switch (imgName) {
    ...
    case 'keychain-red-flower.jpg': return keychainRedFlower;
    case 'keychain-yellow-bloom.jpg': return keychainYellowBloom;
    case 'keychain-blue-heart.jpg': return keychainBlueHeart;
...
export const getProductImage = (item) => {
  ...
  if (id.includes('blue-heart') || id.includes('swan-charm')) return keychainBlueHeart;
