export const productsData = [
  ...
  // 5. CRAFTORIA BLOOM BOUQUETS COLLECTION
  {
    ...
    title: 'Single Stem Bloom Bouquet (1 Flower)',
    description: 'A charming single-stem everlasting pipe cleaner flower wrapped in elegant pastel paper with a satin bow ribbon.',
    price: 199,
    rating: 4.8,
    reviewCount: 42,
    category: 'craftoria-bloom-bouquets',
    thumbnail: 'bloom-bouquets-cover.jpg',
    galleryImages: ['bloom-bouquets-cover.jpg', 'seller-bloom-bouquets.png'],
    stock: 30,
    customizable: true,
    tags: ['bouquet', 'single-stem', 'flower', 'pipe-cleaner', 'cute'],
    featured: false,
    bestSeller: true,
    discount: 50,
    estimatedDelivery: '3-5 Business Days',
  ...
  },
  {
    ...
    title: 'Pastel Trio Bloom Bouquet (3 Flowers)',
    description: 'A delicate 3-flower pipe cleaner bouquet combining roses, daisies, and lavender sprigs wrapped in textured craft paper.',
    price: 399,
    rating: 4.9,
    reviewCount: 78,
    category: 'craftoria-bloom-bouquets',
    thumbnail: 'seller-bloom-bouquets.png',
    galleryImages: ['seller-bloom-bouquets.png', 'bloom-bouquets-cover.jpg'],
    stock: 25,
    customizable: true,
    tags: ['bouquet', 'trio', '3-flowers', 'pastel', 'everlasting'],
    featured: true,
    bestSeller: true,
    discount: 50,
    estimatedDelivery: '3-5 Business Days',
  ...
  },
  {
    ...
    title: 'Luxury Artisan Bloom Bouquet (5 Flowers)',
    ...
    stock: 18,
    customizable: true,
    tags: ['bouquet', 'luxury', '5-flowers', 'full-bouquet', 'anniversary'],
    featured: true,
    bestSeller: true,
    discount: 100,
    estimatedDelivery: '3-5 Business Days',
