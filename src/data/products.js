export const productsData = [
  ...
  },
  {
    ...
    reviewCount: 9,
    category: 'photo-frames',
    thumbnail: 'photo-frame-9x1.jpg',
    galleryImages: ['photo-frame-9x1.jpg', 'gallery-5-child-frame.jpg'],
    stock: 12,
    customizable: true,
  ...
  // 2. EMBROIDERY COLLECTION
  {
    ...
    title: 'Small Embroidery Hoop Frame (3 Inch)',
    description: 'Compact 3-inch wooden embroidery hoop featuring delicate handcrafted floral knots, initials, and pastel thread details.',
    price: 499,
    rating: 4.9,
    reviewCount: 52,
    category: 'embroidery',
    ...
    stock: 15,
    customizable: true,
    tags: ['embroidery', 'small-frame', '3-inch', 'hoop-art', 'floral', 'handmade'],
    featured: true,
    bestSeller: true,
    discount: 0,
  ...
  },
  {
    ...
    title: 'Middle Embroidery Hoop Frame (4 Inch)',
    description: 'Medium 4-inch hoop art with intricate couple silhouettes, anniversary calendar dates, and botanical border stitchwork.',
    price: 999,
    rating: 5.0,
    reviewCount: 68,
    category: 'embroidery',
    ...
    stock: 12,
    customizable: true,
    tags: ['embroidery', 'middle-frame', '4-inch', 'couple-art', 'anniversary', 'custom'],
    featured: true,
    bestSeller: true,
    discount: 0,
    frameAddOn: { label: 'Add Wooden Frame', price: 300 },
  ...
  },
  {
    ...
    title: 'Large Embroidery Hoop Frame (5 Inch)',
    description: 'Grand 5-inch centerpiece embroidery hoop with elaborate floral wreaths, family monograms, and 3D woven stitch accents.',
    price: 1499,
    rating: 4.9,
    reviewCount: 34,
    category: 'embroidery',
    ...
    stock: 8,
    customizable: true,
    tags: ['embroidery', 'large-frame', '5-inch', 'statement-piece', 'floral-wreath', 'luxury'],
    featured: false,
    bestSeller: false,
    discount: 0,
    frameAddOn: { label: 'Add Wooden Frame', price: 300 },
  ...
  {
    id: 'red-velvet-flower-keychain',
    slug: 'red-velvet-flower-keychain',
    title: 'Red Velvet Blossom Keychain',
    description: 'Handmade vibrant red flower keychain featuring soft velvet chenille petals with a cluster of white pearls in the center.',
    price: 99,
    rating: 5.0,
    reviewCount: 95,
    category: 'keychains',
    thumbnail: 'keychain-red-flower.jpg',
    galleryImages: ['keychain-red-flower.jpg', 'gallery-2-blue-flower-keychain.jpg'],
    stock: 40,
    customizable: true,
    tags: ['keychain', 'flower', 'red-flower', 'pearl', 'accessory'],
    featured: true,
    bestSeller: true,
    discount: 0,
    estimatedDelivery: '2-4 Business Days',
  ...
  {
    id: 'yellow-bloom-keychain',
    slug: 'yellow-bloom-keychain',
    title: 'Yellow Bloom Stalk Keychain',
    description: 'Handcrafted bright yellow flower stalk keychain made with fluffy looped chenille petals and a green stem base on a gold hook chain.',
    price: 99,
    rating: 4.8,
    reviewCount: 40,
    category: 'keychains',
    thumbnail: 'keychain-yellow-bloom.jpg',
    galleryImages: ['keychain-yellow-bloom.jpg', 'gallery-2-blue-flower-keychain.jpg'],
    stock: 22,
    customizable: true,
    tags: ['keychain', 'yellow-bloom', 'flower-stalk', 'plush', 'accessory'],
    featured: false,
    bestSeller: false,
    discount: 0,
    estimatedDelivery: '3-5 Business Days',
  ...
  {
    id: 'blue-heart-swan-keychain',
    slug: 'blue-heart-swan-keychain',
    title: 'Sky Blue Heart & Swan Charm Keychain',
    description: 'Cute plush sky blue heart keychain handmade with soft chenille wire, adorned with a delicate white swan enamel charm on a gold ring.',
    price: 99,
    rating: 4.7,
    reviewCount: 28,
    category: 'keychains',
    thumbnail: 'keychain-blue-heart.jpg',
    galleryImages: ['keychain-blue-heart.jpg', 'gallery-2-blue-flower-keychain.jpg'],
    stock: 18,
    customizable: true,
    tags: ['keychain', 'heart', 'swan-charm', 'blue', 'personalized'],
    featured: false,
    bestSeller: false,
    discount: 0,
    estimatedDelivery: '4-6 Business Days',
  ...
  // 4. POLAROIDS COLLECTION
  {
    ...
    reviewCount: 54,
    category: 'polaroids',
    thumbnail: 'polaroids-1x2.jpg',
    galleryImages: ['polaroids-1x2.jpg'],
    stock: 60,
    customizable: true,
  ...
  },
  {
    ...
    reviewCount: 82,
    category: 'polaroids',
    thumbnail: 'polaroids-pack.jpg',
    galleryImages: ['polaroids-pack.jpg'],
    stock: 50,
    customizable: true,
  ...
  },
  {
    ...
    reviewCount: 39,
    category: 'polaroids',
    thumbnail: 'polaroids-1x3.jpg',
    galleryImages: ['polaroids-1x3.jpg'],
    stock: 40,
    customizable: true,
  ...
  },
  {
    ...
    reviewCount: 91,
    category: 'polaroids',
    thumbnail: 'polaroids-music.jpg',
    galleryImages: ['polaroids-music.jpg'],
    stock: 55,
    customizable: true,
  ...
  },
  {
    ...
    category: 'polaroids',
    thumbnail: 'polaroids-pack.jpg',
    galleryImages: ['polaroids-pack.jpg', 'polaroids-music.jpg', 'polaroids-1x2.jpg', 'polaroids-1x3.jpg'],
    stock: 80,
    customizable: true,
  ...
  {
    id: 'pink-blossom-pot-magnet',
    slug: 'pink-blossom-pot-magnet',
    title: 'Pink Blossom Flower Pot Fridge Magnet',
    description: 'Handmade miniature flower pot fridge magnet featuring blooming pink pipe cleaner daisies with pearl centers and a blue heart motif.',
    price: 159,
    rating: 4.9,
    reviewCount: 46,
    category: 'handmade-decor',
    thumbnail: 'pot-magnet-pink-blossom.jpg',
    galleryImages: ['pot-magnet-pink-blossom.jpg', 'flower-vase.jpg'],
    stock: 35,
    customizable: true,
    tags: ['decor', 'magnets', 'flower-pot', 'pipe-cleaner', 'pink-blossom', 'handmade'],
    featured: true,
    bestSeller: true,
    discount: 0,
    estimatedDelivery: '2-4 Business Days',
  ...
  {
    id: 'lavender-tulip-pot-magnet',
    slug: 'lavender-tulip-pot-magnet',
    title: 'Lavender & Tulip Flower Pot Fridge Magnet',
    description: 'Handmade miniature flower pot fridge magnet featuring pastel blue and purple lavender stalks with a vibrant pink tulip center.',
    price: 159,
    rating: 4.9,
    reviewCount: 38,
    category: 'handmade-decor',
    thumbnail: 'pot-magnet-lavender-tulip.jpg',
    galleryImages: ['pot-magnet-lavender-tulip.jpg', 'flower-vase.jpg'],
    stock: 30,
    customizable: true,
    tags: ['decor', 'magnets', 'flower-pot', 'pipe-cleaner', 'lavender', 'tulip', 'handmade'],
    featured: true,
    bestSeller: true,
    discount: 0,
    estimatedDelivery: '2-4 Business Days',
  ...
  },
  {
    ...
    title: 'Table Flower Vases',
    description: 'Handcrafted everlasting pipe-cleaner tabletop flower pot featuring a colorful trio of sky blue, red, and yellow tulips in a fluted pot with pink ruffled trim.',
    price: 199,
    rating: 4.8,
    reviewCount: 29,
    category: 'handmade-decor',
    ...
    stock: 14,
    customizable: true,
    tags: ['decor', 'vase', 'flower-vase', 'tulip-pot', 'pipe-cleaner', 'room-decor'],
    featured: true,
    bestSeller: false,
    discount: 0,
    estimatedDelivery: '3-5 Business Days',
  ...
  {
    id: 'hairband-red-flower',
    slug: 'hairband-red-flower',
    title: 'Red Velvet Blossom Hair Band',
    description: 'Handmade vibrant red flower hair band featuring soft chenille petals with a white spiral swirl core on a flexible elastic band.',
    price: 49,
    rating: 4.9,
    reviewCount: 34,
    category: 'accessories',
    thumbnail: 'hairband-red-flower.jpg',
    galleryImages: ['hairband-red-flower.jpg', 'hair-clips.jpg'],
    stock: 40,
    customizable: true,
    tags: ['accessories', 'hair-band', 'red-flower', 'handmade', 'hair-tie'],
    featured: true,
    bestSeller: true,
    discount: 0,
    estimatedDelivery: '2-4 Business Days',
  ...
  {
    id: 'hairband-pink-rose',
    slug: 'hairband-pink-rose',
    title: 'Pink Rosebud Hair Band',
    description: 'Handcrafted layered soft pink rose hair band adorned with a delicate white pearl center on a durable elastic band.',
    price: 49,
    rating: 5.0,
    reviewCount: 42,
    category: 'accessories',
    thumbnail: 'hairband-pink-rose.jpg',
    galleryImages: ['hairband-pink-rose.jpg', 'hair-clips.jpg'],
    stock: 35,
    customizable: true,
    tags: ['accessories', 'hair-band', 'pink-rose', 'pearl', 'handmade', 'hair-tie'],
    featured: true,
    bestSeller: true,
    discount: 0,
    estimatedDelivery: '2-4 Business Days',
  ...
  },
  {
    ...
    slug: 'hairband-sunflower',
    title: 'Yellow Sunflower Hair Band',
    description: 'Radiant handmade yellow sunflower hair band with textured brown spiral center on a stretchable elastic band.',
    price: 49,
    rating: 4.8,
    reviewCount: 28,
    category: 'accessories',
    thumbnail: 'hairband-sunflower.jpg',
    galleryImages: ['hairband-sunflower.jpg', 'hair-clips.jpg'],
    stock: 30,
    customizable: true,
    tags: ['accessories', 'hair-band', 'sunflower', 'yellow', 'handmade', 'hair-tie'],
    featured: false,
    bestSeller: false,
    discount: 0,
    estimatedDelivery: '2-4 Business Days',
  ...
  {
    id: 'hairband-magenta-daisy',
    slug: 'hairband-magenta-daisy',
    title: 'Magenta Daisy Hair Band',
    description: 'Vibrant hot pink daisy hair band with bright yellow center and green leaf accents on a comfy elastic band.',
    price: 49,
    rating: 4.8,
    reviewCount: 25,
    category: 'accessories',
    thumbnail: 'hairband-magenta-daisy.jpg',
    galleryImages: ['hairband-magenta-daisy.jpg', 'hair-clips.jpg'],
    stock: 30,
    customizable: true,
    tags: ['accessories', 'hair-band', 'magenta-daisy', 'hot-pink', 'handmade', 'hair-tie'],
    featured: false,
    bestSeller: false,
    discount: 0,
    estimatedDelivery: '2-4 Business Days',
...
export const collectionsData = [
  ...
  },
  {
    ...
    descriptionLong: 'Handcrafted floral snap clips, plush flower hair bands, and bespoke initial charm hair accessories made with exquisite attention to detail.'
  }
];
